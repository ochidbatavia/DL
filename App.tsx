...
const App: React.FC = () => {
  const [currentPage, setCurrentPage] = useState<'home' | 'about' | 'product-detail'>('home');
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Navbar onNavigate={navigateTo} activePage={currentPage === 'product-detail' ? 'home' : currentPage} />
